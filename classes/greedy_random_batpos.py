...
class Greedy_Random():
    ...
    def kmeans(self):
        ...
        house_labels = kmeans.labels_

        print(battery_coords)
        # print(np.round(battery_coords))
        print(house_labels)

        # for i, assigned_bat in enumerate(house_labels):
        #     print(self.grid.houses_and_cables[i])
        #
        #     self.smallest_dict[self.grid.houses_and_cables[i]] = battery_coords[assigned_bat]

        return battery_coords, house_labels
